// O7WwBfLvdDDp6fWI53/LfY3qVvr3Y/MW0t9bMDhqoVVpt639HMOB9exumMvvMfLjx4/hIeWjy4hbTp9prQIn8qwf98Ux/2o/sjSkKllpRnSb-1JJuy88J0mF-vTRSaBp5Jd3EckQqJKnKbJ0AoCy-kI4TDaGYrG0wytJGvHPViE6oC0fWf==
// 首先字符串长度为180
/* V 1.0.1.7 */
arg = [
    0,
    1,
    14,
    "offset=0&channel_id=94349549395&max_behot_time=0&category=pc_profile_channel&disable_raw_data=true&aid=24&app_name=toutiao_web&msToken=Uaq1eSBHz7amnMVAZkr4CPPNXPkLOJioWcQ9UnWNKaSMTGM5wLgx9fpMC4bTCvWeSYy4YbAhfNl4rs3dmaymEtaJ_m7POboxJQjCaOX7recipInEa4pykYagF7NzV5zj&msToken=Uaq1eSBHz7amnMVAZkr4CPPNXPkLOJioWcQ9UnWNKaSMTGM5wLgx9fpMC4bTCvWeSYy4YbAhfNl4rs3dmaymEtaJ_m7POboxJQjCaOX7recipInEa4pykYagF7NzV5zj",
    "",
...
function get_a_b(arguments) {
    var r= window._U._v
    return window._U._u(r[0],arguments,r[1],r[2],null)
}

console.log(document.cookie)    //输出cookie
console.log((get_a_b(arg)))
// console.log(str(get_a_b(arg)).length)