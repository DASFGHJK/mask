...
(function (_0x48d404, _0x1e61ca) {
    ...
    function get_t_r_s(page) {
        var _0x2059bf = Date["parse"](new Date());
        var _0x350b3a = _0x1e5c29();

        // 动态生成参数结构
        const dynamicParam = `page=${page}`; // 将固定值3改为参数page

        var _0x3f9dab = x1["stringify"](_0x321804(_0x10b283(dynamicParam || "{}")));
    ...
    window.get_t_r_s = get_t_r_s
});

function get(page) {
    reult = window.get_t_r_s(page)
    console.log(reult)
    return reult
}
get(1)