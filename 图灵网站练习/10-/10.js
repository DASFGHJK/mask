...
function sha256(data) {
    return CryptoJS.SHA256(CryptoJS.enc.Utf8.parse(data))
...
function get_s (page) {
  ...
  _pa = OOOO("/api/problem-detail/10/data/?page="+String(page));
  console.log(_pa)
...
function load(_0x40be62) {
  const _0x1c2c6d = {
    "page": _0x40be62
        ...
        _0xb92e87 = new URLSearchParams(_0x1c2c6d)["toString"]();
